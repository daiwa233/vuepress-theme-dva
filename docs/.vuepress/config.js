 ...
 * @LastEditTime : 2020-02-13 21:59:18
...
module.exports = {
  ...
  head: [
    ...
    ['link', {rel: 'stylesheet', href: '//at.alicdn.com/t/font_1625681_i2f9p9vnaf.css'}],
  ...
  themeConfig: {
    ...
    socialLinks:[
      ...
      {url: 'http://start-here.cn', icon: 'iconfont icon-RSS'},
    ],
    valineConfig: {
  ...
  plugins: [
    [
      ...
      {
        'ga': 'UA-158040086-1' // UA-00000000-0
      }
    ],
    [
      '@vuepress/pwa',
